...
{
    internal class UserRegistrationView : IView
    {
        ...
        public void RunView() {
            ...
            _fieldValidator.FieldArray[(int)FieldConstants.UserRegistrationField.Password] = GetInputFromUser(FieldConstants.UserRegistrationField.Password, $"Please enter your password:d{Environment.NewLine}(Your password must contain at least 1 small-case letter,{Environment.NewLine}1 Capital letter, 1 digit, 1 special character{Environment.NewLine} and the length should be between 6-10 characters): ");
            ...
            _fieldValidator.FieldArray[(int)FieldConstants.UserRegistrationField.PostalCode] = GetInputFromUser(FieldConstants.UserRegistrationField.PostalCode, "Please enter your post code: ");
